...
if ($conn) {
    try {
        ...
        $stats = ['users' => 0, 'sermons' => 0, 'events' => 0, 'news' => 0, 'gallery' => 0];
    }
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="admin-layout">
        ...
        <aside class="admin-sidebar">
            <div class="p-4">
                <h5 style="color: var(--heavenly-gold); margin-bottom: 1rem;">
            ...
            <div class="content-section">
                ...
                <div class="stats-grid">
                    <a href="?section=sermons" class="stat-card">
                        ...
                        <div class="stat-number">Add Sermon</div>
                        <div>Add New Sermon</div>
                    </a>
                    ...
                    <a href="?section=events" class="stat-card">
                        ...
                        <div class="stat-number">Add Event</div>
                    ...
                    <a href="?section=news" class="stat-card">
                        ...
                        <div class="stat-number">Add News</div>
                        <div>Create News Article</div>
                    </a>
                    ...
                    <a href="?section=gallery" class="stat-card">
                        ...
                        <div class="stat-number">Upload Media</div>
