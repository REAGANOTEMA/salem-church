...
<body>
                                ...
                                <div class="col-md-2 text-center">
                                    <div class="user-avatar">
                                        <?php if ($user_info && !empty($user_info['profile_image'])): ?>
                                            <img src="uploads/profiles/<?php echo htmlspecialchars($user_info['profile_image']); ?>" alt="Profile" style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">
                                        <?php else: ?>
    ...
    <script>
        ...
        function viewPost(type, id) {
            switch(type) {
                case 'sermon':
                    window.location.href = 'sermons.php#sermon-' + id;
                    break;
                case 'news':
                    window.location.href = 'news.php#news-' + id;
                    break;
                case 'event':
