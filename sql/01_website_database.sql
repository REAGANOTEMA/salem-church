...
-- STEP 1: Website Database (salemdominionmin_website)
-- ============================================================
-- Run this in phpMyAdmin or MySQL CLI
-- Contains: Public-facing content tables
-- ============================================================

CREATE DATABASE IF NOT EXISTS `salemdominionmin_website`
...
-- Verify
SELECT 'Website database created successfully!' AS status;
...
-- 26. prophetic_school_applications
...
-- 28. pastor_booking_availability
...
VALUES
  (1, 'Sunday Morning Worship Service', 'Join us for a powerful time of worship and the Word. Every Sunday we gather to lift the name of Jesus and receive fresh anointing for the week ahead. Come expecting a miracle!', DATE_ADD(CURDATE(), INTERVAL 7 DAY), '09:00:00', '12:00:00', 'Main Sanctuary', 'Salem Dominion Ministries HQ', 'Apostle Faty Musasizi', 500, 1, 'upcoming', 1),
  (2, 'Midweek Prayer Meeting', 'Experience the presence of God through corporate prayer and intercession. Join us every Wednesday evening as we pray for the church, the nation, and one another. Prayer changes things!', DATE_ADD(CURDATE(), INTERVAL 2 DAY), '18:30:00', '20:30:00', 'Prayer Hall', 'Salem Dominion Ministries HQ', 'Pastor Faty Musasizi', 200, 0, 'upcoming', 1),
  (3, 'Youth Conference 2026', 'A special conference designed to empower and equip the next generation for kingdom impact. Three days of intense worship, teaching, and ministry. Register now to secure your spot!', DATE_ADD(CURDATE(), INTERVAL 30 DAY), '10:00:00', '18:00:00', 'Main Sanctuary', 'Salem Dominion Ministries HQ', 'Apostle Faty Musasizi', 800, 1, 'upcoming', 1),
  (4, 'Easter Sunday Celebration', 'Celebrate the resurrection of our Lord Jesus Christ with us! A special Easter service filled with praise, worship, and a powerful Easter message of hope and new beginnings.', DATE_SUB(CURDATE(), INTERVAL 90 DAY), '08:00:00', '12:00:00', 'Main Sanctuary', 'Salem Dominion Ministries HQ', 'Apostle Faty Musasizi', 500, 1, 'completed', 1),
  (5, 'Leadership Summit 2025', 'An equipping session for all ministry leaders and department heads. Topics include effective leadership, team management, and spiritual growth for leaders.', DATE_SUB(CURDATE(), INTERVAL 45 DAY), '09:00:00', '16:00:00', 'Conference Room', 'Salem Dominion Ministries HQ', 'Apostle Faty Musasizi', 100, 0, 'completed', 1);

-- Event Registrations (no sample data)
...
VALUES
  (1, 'The Power of Faith', 'A powerful message about the importance of faith in our daily lives and how it can transform our relationship with God. Learn to activate your faith for miracles.', 'Apostle Faty Musasizi', DATE_SUB(CURDATE(), INTERVAL 7 DAY), 'Faith', 'Walking in Power', 'video', 'https://www.youtube.com/watch?v=example1', 'Hebrews 11:1', 2840, 'published', 1, 1250, 1),
  (2, 'Walking in Divine Purpose', 'Discovering and fulfilling God''s divine purpose for your life through biblical principles and practical application. Every believer has a purpose - find yours!', 'Apostle Faty Musasizi', DATE_SUB(CURDATE(), INTERVAL 14 DAY), 'Purpose', 'Walking in Power', 'video', 'https://www.youtube.com/watch?v=example2', 'Jeremiah 29:11', 3120, 'published', 1, 980, 1),
  (3, 'The Blessing of Obedience', 'Understanding how obedience to God''s word brings blessings and breakthroughs in every area of life. Obedience is better than sacrifice.', 'Pastor Faty Musasizi', DATE_SUB(CURDATE(), INTERVAL 21 DAY), 'Obedience', NULL, 'audio', 'https://audio.salem-dominion-ministries.com/sermon3.mp3', 'Deuteronomy 28:1-2', 2640, 'published', 0, 756, 1),
  (4, 'Spiritual Warfare: Winning the Battle', 'An in-depth teaching on spiritual warfare and the armor of God. Learn how to stand firm against the enemy''s tactics and claim your victory in Christ.', 'Apostle Faty Musasizi', DATE_SUB(CURDATE(), INTERVAL 28 DAY), 'Spiritual Warfare', 'Battle Ready', 'video', 'https://www.youtube.com/watch?v=example4', 'Ephesians 6:10-18', 3600, 'published', 0, 1420, 1),
  (5, 'The Heart of Worship', 'What does it truly mean to worship God in spirit and truth? This sermon explores the essence of genuine worship and how it transforms our relationship with God.', 'Apostle Faty Musasizi', DATE_SUB(CURDATE(), INTERVAL 35 DAY), 'Worship', NULL, 'video', 'https://www.youtube.com/watch?v=example5', 'John 4:23-24', 2400, 'published', 0, 890, 1);
...
VALUES
  (1, 'John Doe', 'john.doe@example.com', 'Business Owner', 'Salem Dominion Ministries has truly transformed my life. The teachings are powerful, the worship is heavenly, and the community is amazing. I came as a visitor and found my spiritual home. God bless Apostle Faty and the entire leadership.', 5, 1, 1, 'approved', 1),
  (2, 'Jane Smith', 'jane.smith@example.com', 'Teacher', 'I found my spiritual home here. The worship is uplifting and the messages are life-changing. Since joining Salem Dominion, my faith has grown immensely and I have experienced God''s faithfulness in my career and family.', 5, 1, 1, 'approved', 1),
  (3, 'Michael Johnson', 'michael.j@example.com', 'Student', 'The youth ministry helped me discover my purpose in God. Through the mentorship and programs, I have grown from a confused young man to a confident servant of God. I am forever grateful to Salem Dominion Ministries.', 4, 1, 0, 'approved', 1);

-- Announcements
INSERT IGNORE INTO `announcements` (`id`, `title`, `content`, `is_pinned`, `start_date`, `end_date`, `status`, `created_by`)
VALUES
  (1, 'New Building Project - Phase 1 Begins', 'We are thrilled to announce that Phase 1 of our new church building project has officially begun. We encourage every member to contribute towards this vision. See the finance team for details.', 1, DATE_SUB(CURDATE(), INTERVAL 30 DAY), DATE_ADD(CURDATE(), INTERVAL 365 DAY), 'active', 1),
  (2, 'Easter Sunday Service Special', 'Join us for a powerful Easter Sunday celebration. We will have a special sunrise service at 6:00 AM followed by the main service at 9:00 AM. Invite your friends and family!', 0, DATE_SUB(CURDATE(), INTERVAL 14 DAY), DATE_ADD(CURDATE(), INTERVAL 7 DAY), 'active', 1),
  (3, 'Church Registration Drive', 'All members are encouraged to register with the church database for better communication and pastoral care. Please see the secretary after any service to complete your registration.', 0, DATE_SUB(CURDATE(), INTERVAL 60 DAY), DATE_ADD(CURDATE(), INTERVAL 30 DAY), 'inactive', 1);
...
-- ============================================================
--
--  1.  news_categories              (5 categories)
--  2.  news                         (5 articles)
--  3.  events                       (5 events)
--  4.  event_registrations          (registration data)
--  5.  sermons                      (5 sermons)
--  6.  albums                       (3 albums)
--  7.  gallery                      (3 items)
--  8.  youtube_live                 (1 live config)
--  9.  donations                    (3 donations)
-- 10.  donation_campaigns           (1 campaign)
-- 11.  prayer_requests              (3 requests)
-- 12.  contact_messages             (3 messages)
-- 13.  newsletter_subscribers       (3 subscribers)
-- 14.  settings                     (20 settings)
-- 15.  homepage_sections            (7 sections)
-- 16.  bible_verses                 (5 verses)
-- 17.  leadership                   (3 members)
-- 18.  departments                  (4 departments)
-- 19.  ministries                   (5 ministries)
-- 20.  branches                     (1 branch)
-- 21.  testimonials                 (3 testimonials)
-- 22.  announcements                (3 announcements)
-- 23.  seo                          (8 page SEO configs)
-- 24.  menus                        (10 nav items)
-- 25.  page_content                 (7 page sections)
-- 26.  prophetic_school_applications (application system)
-- 27.  pastor_bookings              (booking system)
-- 28.  pastor_booking_availability  (5 schedules)
--
-- ============================================================
